...
| `test-analytics.yml` | Manually generates public analytics only into `README-test.md` and `analytics-test-assets/`; use it for isolated owner testing before touching the live profile. |
...
2. Confirm only `README-test.md` and `analytics-test-assets/` were committed.
